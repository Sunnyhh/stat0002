...
```
$$\text{Odds Ratio of (V = 0)} = \frac{0.5217}{1 - 0.5217} / \frac{0.3029}{1 - 0.3029} = 2.510$$
$$\text{Odds Ratio of (V = 2)} = \frac{0.2826}{1 - 0.2826} / \frac{0.5922}{1 - 0.5922} = 0.2712$$
We can either compare the estimated conditional probabilities of the doses of vaccines injected given having flu or not presented in the table above, or compare the Odds Ratio at $V = 0$ and $V = 2$ calculated above. We can clearly see that a large proportion of people who caught flu did not inject the vaccine, while about $70\%$ of people who didn't catch flu at least injected one dose of vaccine. Therefore, we can draw the conclusion that there is a negative association between V and F.

## Improvement
**uppose that each person in this survey made their own decision whether to have $0$, $1$, or $2$ vaccine injections. Can you see a potential problem with this? What would be a better way to find out how effective is the vaccine at preventing flu?** \
